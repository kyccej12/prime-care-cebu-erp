...
<head>
	...
	<script>
		...
		function refreshList() {
			$('#itemlist').DataTable().ajax.url("data/polist.php").load();
		}
...
<body bgcolor="#ffffff" leftmargin="0" bottommargin="0" rightmargin="0" topmargin="0" >
	<table width="100%" cellspacing="0" cellpadding="0" style="padding-left: 5px; margin-bottom:2px;">
		<tr>
			<td>
				<button class="ui-button ui-widget ui-corner-all" onClick="parent.viewPO('');">
					<span class="ui-icon ui-icon-plusthick"></span> Create Purchase Order
				</button>
				<button class="ui-button ui-widget ui-corner-all" onClick="viewPO();">
				...
				<button class="ui-button ui-widget ui-corner-all" onClick="searchRecord();">
					<span class="ui-icon ui-icon-gear"></span> Detailed Search
				</button>
			</td>
		</tr>
	</table>
