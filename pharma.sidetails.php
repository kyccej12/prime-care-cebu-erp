			...
			<tr>
				<td width=60% valign=top>
					<table width=100% style="padding:0px 0px 0px 0px;">
						...
						<tr>
							<td align="left" width="25%" class="bareBold" style="padding-left: 35px;">Payment Type&nbsp;:</td>
							<td align=left>
								<select class="gridInput" style="width:50%;" type=text name="payment_type" id="payment_type">
									<option value='' <?php if($res['payment_type'] == '') { echo "selected"; }?>>- N/A -</option>
									<option value='Card' <?php if($res['payment_type'] == 'Card') { echo "selected"; }?>>- Card -</option>
								</select>
							</td>				
						</tr>
					</table>
...
<div id="discounter" style="display: none;">
	<table width="100%" cellpadding=2 cellspacing=2>
		...
		<tr>
			...
			<td>
				<input type="text" name="discountPercent" id="discountPercent" class="gridInput" style="width: 80%; font-size: 11px;" pattern="^\d*(\.\d{0,2})?$" value="0">
			</td>
		</tr>
	</table>
</div>
<div id="cashTender" style="display: none;">
	<table width=100% cellpadding=0 cellspacing=0>
		...
		<tr><td height=4>&nbsp;</td></tr>
		<tr>
			<td align=left><b>CASH TENDERED:</b><br/><input type="text" name="cashTendered" id="cashTendered" class="gridInput" style="height: 40px; font-size: 22px; font-weight: bold; text-align: right; width: 100%;" value="<?php echo number_format($res['cash_tendered'],2); ?>" onchange="javascript: computeChange(this.id);"></td>
		</td>
		<tr><td height=4>&nbsp;</td></tr>
		<tr>
			<td align=left><b>AMOUNT PAID VIA CARD : </b><br/><input type="text" name="ccTendered" id="ccTendered" class="gridInput" style="height: 40px; font-size: 22px; font-weight: bold; text-align: right; width: 100%;" value="<?php echo number_format($res['cc_tendered'],2); ?>" onchange="javascript: computeChange(this.id);"></td>
		</td>
		<tr><td height=4>&nbsp;</td></tr>
		<tr>
