...
function saveHeader() {
	...
	if(msg != "") {
		...
		$.post("pharma.sidatacontrol.php", { mod: "saveHeader", trace_no: $("#trace_no").val(),doc_no: $("#doc_no").val(), doc_date: $("#doc_date").val(), si_no: $("#si_no").val(), cid: $("#customer_code").val(), cname: $("#customer_name").val(), caddr: $("#customer_address").val(), terms: $("#terms").val(), payment_type: $("#payment_type").val(), sc_id: $("#scpwd_id").val(), remarks: $("#remarks").val(), sid: Math.random() }, function (data) {
