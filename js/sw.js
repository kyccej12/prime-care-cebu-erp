...
function saveSWHeader() {
	...
	if($("#cost_center").val() == '190') {
		if($("#clinic_id").val() == '') {
			msg = msg + "- For withdrawals related to Clinic Management, you must specify the clinic the supplies are intended to...<br/>";
		}
	}
