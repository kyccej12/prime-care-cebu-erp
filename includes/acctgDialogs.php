...
<div id="salesPerCat" style="display:none;">	
	<table border="0" cellpadding="0" cellspacing="0" width=100% class="td_content" style="padding: 10px;">
		<tr>
			<td width=35%><span class="spandix-l">Sales Category :</span></td>
			<td>
				<select id="salescat_cat" style="width: 80%; font-size: 11px;" class="gridInput" />
					<option value="">- All -</option>
					<?php
						$catQuery = $o->dbquery("select sales_id, sales_category from options_salescategory order by sales_category;");
		...
		<?php 
			...
			$o->_structInput('From','35%','salescat_dtf','gridInput','width: 80%;',date('m/01/Y'));
			$o->_structInput('To','35%','salescat_dt2','gridInput','width: 80%;',date('m/d/Y')); 
		?>
		<tr><td colspan=2><hr></hr></td></tr>
		<tr>
			<td align=center colspan=2>
				<button onClick="generateSalesCat();" class="buttonding" style="font-size: 11px;"><img src="images/icons/excel.png" width=18 height=18 align=absmiddle />&nbsp;&nbsp;Generate Report in Excel</button>
			</td>
		</tr>
	</table>
</div>
...
<div id="dsr" style="display:none;">	
	<table border="0" cellpadding="0" cellspacing="0" width=100% style="padding: 10px;">
		<tr>
			<td width=35% valign=top align=right style="padding-right: 20px;"><span class="spandix-l">Customer : </span></td>
			<td>
				<input type="text" name="dsr_customer" id="dsr_customer" class="inputSearch2" style="width: 80%;padding-left: 22px;" placeholder = 'All Customers' />
			</td>
		</tr>
		<tr><td height=4></td></tr>
		<tr>
			<td width=35% valign=top align=right style="padding-right: 20px;"><span class="spandix-l">Covered Period : </span></td>
			<td>
		...
		<tr><td height=4></td></tr>
		<tr>
			<td width=35% align=right style="padding-right: 20px;"><span class="spandix-l">Product or Service : </span></td>
			<td>
				<input type="text" id="dsr_idesc" class="inputSearch2" style="width: 80%; padding-left: 22px;" value="" onchange="javascript: if(this.value == '') { $('#dsr_icode').val(''); }"/>
				<input type="hidden" id="dsr_icode">
			</td>
		</tr>
		<tr><td height=4></td></tr>
		<tr>
			<td width=35% valign=top align=right style="padding-right: 20px;"><span class="spandix-l">Cashier :</span></td>
			<td>
				<select name="dsr_uid" id="dsr_uid" class="gridInput" style="width: 80%; font-size: 11px;">
					<option value="">- All Cashiers -</option>
					<?php
						$ui_dsr = $o->dbquery("SELECT DISTINCT a.created_by AS uid, b.fullname FROM or_header a LEFT JOIN user_info b ON a.created_by = b.emp_id WHERE updated_by IS NOT null;");
						while($ui_dsrrow = $ui_dsr->fetch_array()) {
							echo "<option value = '$ui_dsrrow[0]'>$ui_dsrrow[1]</option>";
						}
						unset($ui_dsr);
					?>
				</select>
...
<div id="dcr" style="display:none;">	
	<table border="0" cellpadding="0" cellspacing="0" width=100% style="padding: 10px;">
		<tr>
			<td width=35% valign=top align=right style="padding-right: 20px;"><span class="spandix-l">Customer : </span></td>
			<td>
				<input type="text" name="dcr_customer" id="dcr_customer" class="inputSearch2" style="width: 80%;padding-left: 22px;" placeholder = 'All Customers' />
			</td>
		</tr>
		...
		<tr>
			<td width=35% valign=top align=right style="padding-right: 20px;"><span class="spandix-l">Covered Period : </span></td>
			<td>
				<input type="text" id="dcr_dtf" class="dcr_dtf" style="width: 80%;" value="<?php echo date('m/d/Y'); ?>" />
			</td>
		</tr>
		<tr><td height=6></td></tr>
		<tr>
			<td width=35% valign=top><span class="spandix-l"></span></td>
			<td>
				<input type="text" id="dcr_dt2" class="dcr_dt2" style="width: 80%;" value="<?php echo date('m/d/Y'); ?>" />
			</td>
		</tr>
		<tr><td height=6></td></tr>
	</table>
</div>
<div id="apeSummary" style="display:none;">	
	<table border="0" cellpadding="0" cellspacing="0" width=100% style="padding: 10px;">
		<tr>
			<td width=35% valign=top align=right style="padding-right: 20px;"><span class="spandix-l">Billed To : </span></td>
			<td>
				<input type="text" name="ape_customer" id="ape_customer" class="inputSearch2" style="width: 80%;padding-left: 22px;" placeholder = 'All Customers' />
			</td>
		</tr>
		<tr><td height=6></td></tr>
		<tr>
			<td width=35% valign=top align=right style="padding-right: 20px;"><span class="spandix-l">Referred By : </span></td>
			<td>
				<input type="text" name="ape_referredby" id="ape_referredby" class="inputSearch2" style="width: 80%;padding-left: 22px;" placeholder = 'All Companies' />
			</td>
		</tr>
		<tr><td height=6></td></tr>
		<tr>
			<td width=35% valign=top align=right style="padding-right: 20px;"><span class="spandix-l">Covered Period : </span></td>
			<td>
				<input type="text" id="ape_dtf" class="ape_dtf" style="width: 80%;" value="<?php echo date('m/d/Y'); ?>" />
			</td>
		</tr>
		<tr><td height=6></td></tr>
		<tr>
			<td width=35% valign=top><span class="spandix-l"></span></td>
			<td>
				<input type="text" id="ape_dt2" class="ape_dt2" style="width: 80%;" value="<?php echo date('m/d/Y'); ?>" />
			</td>
		</tr>
		<tr><td height=6></td></tr>
	</table>
</div>
<div id="cashreceipts" style="display:none;">	
	<table border="0" cellpadding="0" cellspacing="0" width=100% style="padding: 10px;">
		<tr>
			<td width=35% valign=top align=right style="padding-right: 20px;"><span class="spandix-l">Customer : </span></td>
			<td>
				<input type="text" name="crs_customer" id="crs_customer" class="inputSearch2" style="width: 80%;padding-left: 22px;" placeholder = 'All Customers' />
			</td>
		</tr>
		<tr><td height=4></td></tr>
		<tr>
			<td width=35% valign=top align=right style="padding-right: 20px;"><span class="spandix-l">Covered Period : </span></td>
			<td>
				<input type="text" id="crs_dtf" class="crs_dtf" style="width: 80%;" value="<?php echo date('m/d/Y'); ?>" />
			</td>
		</tr>
		<tr><td height=4></td></tr>
		<tr>
			<td width=35% valign=top><span class="spandix-l"></span></td>
			<td>
				<input type="text" id="crs_dt2" class="crs_dt2" style="width: 80%;" value="<?php echo date('m/d/Y'); ?>" />
			</td>
		</tr>
		<tr><td height=4></td></tr>
		<tr>
			<td width=35% valign=top align=right style="padding-right: 20px;"><span class="spandix-l">Cashier :</span></td>
			<td>
				<select name="crs_uid" id="crs_uid" class="gridInput" style="width: 80%; font-size: 11px;">
					<option value="">- All Cashiers -</option>
					<?php
						$ui_dsr = $o->dbquery("SELECT DISTINCT a.created_by AS uid, b.fullname FROM or_header a LEFT JOIN user_info b ON a.created_by = b.emp_id WHERE updated_by IS NOT null;");
						while($ui_dsrrow = $ui_dsr->fetch_array()) {
