			...
			<td width=30% valign=top>
				<table width=100%>
					<tr>
						<td width=100%>
							<table width=100% style="border: 1px solid #cdcdcd;">
								<tr><td class="dgridhead" width=100%>TOTAL ACTIVE EMPLOYEES <?php echo $month; ?></td></tr>
					...
					<tr>
						<td width=100%>
							<table width=100% style="border: 1px solid #cdcdcd;">
								<tr><td class="dgridhead" width=100%>REGULAR EMPLOYEES <?php echo $month; ?></td></tr>
					...
					<tr>
						<td width=100%>
							<table width=100% style="border: 1px solid #cdcdcd;">
								<tr><td class="dgridhead" width=100%>NON-REGULAR EMPLOYEES (<?php echo $month; ?>)</td></tr>
					...
					<tr>
						<td width=100%>
							<table width=100% style="border: 1px solid #cdcdcd;">
								<tr><td class="dgridhead" width=100% colspan=2>ACTIVE MANPOWER COMPLIMENT PER DEPARTMENT</td></tr>
								<?php
			...
			<td width=70% valign=top>
				<table width=100% cellspacing=1>
					<tr><td colspan=2 style="border: 1px solid #cdcdcd;" width=100%>
							<table width=100%>
								<tr><td width=100% class="dgridhead" width=100%>Yearly Comprative Salaries & Wages Expense</td></tr>
					...
					<tr>
						<td style="border: 1px solid #cdcdcd;" width=50% valign=top>
							<table width=100% style="border: 1px solid #cdcdcd;">
								<tr><td class="dgridhead" width=100%>Salaries & Wages Breakdown Per Department</td></tr>
