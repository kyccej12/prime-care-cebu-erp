<?php
	...
	while($row = $datares->fetch_array(MYSQLI_ASSOC)){
		...
		$a = dbquery("SELECT DISTINCT CONCAT ('<a href=\"#\" onclick=\"parent.viewCV(',a.cv_no,')\" style=\"text-decoration: none;\">','CV-',LPAD(a.cv_no,6,0),'</a>') AS xdoc FROM cv_header a LEFT JOIN cv_details b ON a.cv_no = b.cv_no AND a.branch = b.branch WHERE  b.ref_no =  TRIM(LEADING '0' FROM '$row[apv]') AND ref_type = 'APV' AND a.branch = '$_SESSION[branchid]';");
