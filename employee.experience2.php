		...
		<td  style="padding:0px;" valign=top>
			...
			<div id="details" style="height:340px; overflow: auto;">
				...
				<?php
					...
					$getRec = dbquery("select record_id,previous_title,concat(date_format(previous_start,'%m/%d/%Y'),' ',date_format(previous_end,'%m/%d/%Y')) as covered_period, previous_responsibilities, new_title, date_format(new_start,'%m/%d/%Y') as xstart, new_responsibilities from pccpayroll.emp_internalhistory where emp_id='$emp_idno';");
