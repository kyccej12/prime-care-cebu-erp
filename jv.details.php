...
<head>
	...
	<script language="javascript" src="js/tableH.js?sid=<?php echo uniqid(); ?>"></script>
	<script>
...
<div style="padding: 10px;">
	<form name="xform" id="xform">
		...
		<table width=100% cellpadding = 0 cellspacing = 0 align=right style="padding-top: 10px;" class="td_content">
			<tr>
...
<div id="applyInvoice" style="padding: 10px; display: none;">
	<form name="frmInvoice" id="frmInvoice">
		<table align=center border=0 width=100% cellpadding=0 cellspacing=3>
			...
			<tr><td height=2></td></tr>
			<tr><td class=spandix-l align=right style="padding-right: 10px;">Cost Center :</td>
				<td align=left>
					<select name="app_costcenter" id="app_costcenter" class="gridInput" style="width:140px;">
					<?php
						$qcquery = $p->dbquery("select unitcode, costcenter from options_costcenter order by costcenter;");
						while(list($unitcode,$costcenter) = $qcquery->fetch_array()) {
							echo "<option value='$unitcode' title='$costcenter'>$costcenter</option>";
						}
					?>	
					</select>
				</td>
