<?php 
	...
	$o = new _init;
	if(isset($_SESSION['authkey'])) { $exception = $o->validateKey(); if($o->exception != 0) {	$URL = $HTTP_REFERER . "emr/index.php?exception=" . $o->exception; } } else { $URL = $HTTP_REFERER . "emr"; }
...
<body bgcolor="#ffffff" leftmargin="0" bottommargin="0" rightmargin="0" topmargin="0" <?php if($o->cpass == 'Y') { echo "onLoad=\"showChangePass();\""; } ?> style="background: url(images/pcc-bg.jpg); background-size: 100% 100%; background-repeat: no-repeat;">
 <table height="100%" width="100%" border="0" cellspacing="0" cellpadding="0" >
	<tr>
		...
		<td align=right style="height:37px; padding-right: 5px; background-color:#595959; background-image: url(images/4.png);"><img src="images/icons/user.png" align=absmiddle border=0 width=18 height=18 /><span style="font-size: 11px; font-weight: bold; color: #ffffff;">&nbsp;<?php echo $o->getUname($_SESSION['userid']) . ' @ ' .'ROOM' .'&nbsp;'. $_SESSION['clinic_no'] ?>&nbsp;&nbsp;&nbsp;|</span>&nbsp;<a href="logout_emr.php" style="font-size: 12px; font-weight: bold; color: #ffffff; text-decoration: none;" title="Click to Logout"><img src="images/button-logout.png" align=absmiddle border=0 width=24 height=24 />Logout</a></td>
	</tr>
	<tr height=90%>
		<td colspan=3>
