	...
	<script>
		...
		$(document).ready(function($) {
			...
			<?php if($status == 'Finalized' || $status == 'Cancelled') {
				echo "$('#xform :input:not([name=setActive], [name=setPrint], [name=or_no], [name=cash_type])').prop('disabled',true);";
			} else { ?>
				$("#so_date").datepicker(); 
				$("#loa_date").datepicker();
				$("#ck_date").datepicker();
				...
				<td width=60% valign=top>
					<table width=100% style="padding:0px 0px 0px 0px;">
						...
						<tr>
							...
							<td align=left>
								<input class="gridInput" style="width:25%;" type=text name="or_no" id="or_no" value="<?php echo $res[or_no]; ?>" onchange="javascript: changeORNO();">
							</td>				
						</tr>
						<tr>
						...
						<tr>
							...
							<td align=left>
								<select class="gridInput" style="width:65%;" name="cash_type" id="cash_type" onchange="javascript: saveCash();">
									<?php
				...
				<td valign=top>
					<table border="0" cellpadding="0" cellspacing="1" width=100%>
						...
						<tr>
							...
							<td align=left>
								<select class="gridInput" style="width:70%;" type=text name="is_pwd" id="is_pwd">
			...
			<tr>
				<td width=60% valign=top>
					...
					<?php if($status == 'Active' || $status == '') { ?>
						...
						<a href="#" class="topClickers" onClick="javascript:passWordCheck();"><img src="images/icons/discount-icon.png" width=16 height=16 border=0 align="absmiddle">&nbsp;Line Discount (Shift + D)</a >&nbsp;
				...
				<td align=right width=50% valign=top>					
					<span class="bareBold"><b>Gross Sales :</b></span> &nbsp;&nbsp;<input style="width:150px;text-align:right;" type=text name="grossSales" id="grossSales" value="<?php echo number_format($res['grossSales'],2); ?>" readonly><br/>
					...
					<span class="bareBold">Non Vat Sales :</span> &nbsp;&nbsp;<input style="width:150px;text-align:right;" type=text name="nonvat" id="nonvat" value="<?php echo number_format($res['nonvat'],2); ?>" readonly><br/>
					<span class="bareBold">Vatable Sales :</span> &nbsp;&nbsp;<input style="width:150px;text-align:right;" type=text name="netofvat" id="netofvat" value="<?php echo number_format($res['net_of_vat'],2); ?>" readonly><br/>	
					<span class="bareBold">Value-Added-Tax :</span> &nbsp;&nbsp;<input style="width:150px;text-align:right;" type=text name="vat" id="vat" value="<?php echo number_format($res['vat'],2); ?>" readonly><br/>
...
<div id="cashTender" style="display: none;">
	<table width=100% cellpadding=0 cellspacing=0>
		<tr><td height=4>&nbsp;</td></tr>
		<tr>
			<td align=left><b>Total Amount Due :</b><br/><input type="text" name="balanceDue" id="balanceDue" value="<?php echo number_format($res['amount_due'],2); ?>" class="gridInput" style="height: 40px; font-size: 22px; font-weight: bold; text-align: right; width: 100%;" readonly></td>
		</td>
		<tr><td height=4>&nbsp;</td></tr>
		<tr>
			<td align=left><b>Amount Paid in Cash :</b><br/><input type="text" name="cashTendered" id="cashTendered" class="gridInput" style="height: 40px; font-size: 22px; font-weight: bold; text-align: right; width: 100%;" value="<?php echo number_format($res['cash_tendered'],2); ?>" onchange="javascript: computeChange(this.id);"></td>
		</td>
		<tr><td height=4>&nbsp;</td></tr>
		<tr>
			<td align=left><b>Amount Paid via Credit Card : </b><br/><input type="text" name="ccTendered" id="ccTendered" class="gridInput" style="height: 40px; font-size: 22px; font-weight: bold; text-align: right; width: 100%;" value="<?php echo number_format($res['cc_tendered'],2); ?>" onchange="javascript: computeChange(this.id);"></td>
		</td>
		<tr><td height=4>&nbsp;</td></tr>
		<tr>
			<td align=left><b>Amount Paid via On-date Check :</b><br/><input type="text" name="checkTendered" id="checkTendered" class="gridInput" style="height: 40px; font-size: 22px; font-weight: bold; text-align: right; width: 100%;" value="<?php echo number_format($res['check_tendered'],2); ?>" onchange="javascript: computeChange(this.id);"></td>
		</td>
		<tr><td height=4>&nbsp;</td></tr>
		<tr>
...
<div id="updateEntry" style="display: none;">
	<form name="frmUpdateEntry" id="frmUpdateEntry">
		<input type="hidden" id="recordId" name="recordId">
		<table width="100%" cellspacing=2 cellpadding=0 >
			<tr>
				<td class="bareThin" align=left width=40%>SO # :</td>
				<td align=left>
					<input type="text" name="itemSO" id="itemSO" class="inputSearch2" style="width: 80%; padding-left: 22px;" readonly>
				</td>
			</tr>
			<tr>
				<td class="bareThin" align=left width=40%>SOA # :</td>
				<td align=left>
					<input type="text" name="itemSOA" id="itemSOA" class="gridInput" style="width: 80%;" readonly>
				</td>
			</tr>
			<tr>
				<td class="bareThin" align=left width=40%>Patient :</td>
				<td align=left>
					<input type="text" name="itemPatient" id="itemPatient" class="gridInput" style="width: 80%;" readonly>
				</td>
			</tr>
			<tr>
				<td class="bareThin" align=left width=40%>Procedure :</td>
				<td align=left>
					<input type="text" name="itemProc" id="itemProc" class="gridInput"style="width: 80%;" value=0 onchange="javascript: computeItemAmount(this.value);">
				</td>
			</tr>
			<tr>
				<td class="bareThin" align=left width=40%>Unit Price :</td>
				<td align=left>
					<input type="text" name="itemPrice" id="itemPrice" class="gridInput" style="width: 80%;" value='0.00' disabled>
				</td>
			</tr>
			<tr>
				<td class="bareThin" align=left width=40%>Discount :</td>
				<td align=left>
					<input type="text" name="itemDiscount" id="itemDiscount" class="gridInput" style="width: 80%;" value='0.00' disabled>
				</td>
			</tr>
			<tr>
				<td class="bareThin" align=left width=40%>Amount :</td>
				<td align=left>
					<input type="text" name="itemAmountDue" id="itemAmountDue" class="gridInput" style="width: 80%;" value='0.00'>
				</td>
			</tr>
		</table>
	</form>
