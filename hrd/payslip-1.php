<?php
	...
	$q = $pay->dbquery("select * from pccpayroll.emp_payslip a where period_id = '$cutoff' $f1 $f2 order by emp_name asc;");
			...
			<tr>
				<td width=50% style="border: 0.1em solid black; border-collapse: collapse;">
					<table width=100% cellpadding=0 cellspacing=0>
						...
						$adjQuery = $pay->dbquery("select remarks, amount from pccpayroll.emp_adjustments where emp_id = '$res[emp_id]' and period_id = '$cutoff';");
