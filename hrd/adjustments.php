			...
			$("#record").dialog({title: "New Record", width: 440, resizable: false, modal: true, buttons: {
				"Save Record": function() {
					...
					if(msg != "") { parent.sendErrorMessage(msg); } else {
						$.post("misc-data.php", { mod: "newAdjustment", emp_id: $("#emp_id").val(), type: $("#type").val(), nature: $("#nature").val(), date: $("#adjdate").val(), amount: $("#amount").val(), taxable: $("#is_taxable").val(), remarks: $("#remarks").val(), sid: Math.random() }, function() {
		...
		<form name="irec" id="irec">
			<table width=100% cellspacing=2 cellpadding=0>
				...
				<tr>
					...
					<td align=left>
						<select name="type" id="type" class="gridInput" style="width: 80%; font-size: 11px;">
				...
				<tr>
					<td class="bareThin" align=left width=40%>Nature of Adjustment :</td>
					<td align=left>
						<select name="nature" id="nature" class="gridInput" style="width: 80%; font-size: 11px;">
							<option value="1">- Adjustment to Basic Salary, Holiday Pay & SIL -</option>
							<option value="2">- Adjustment to Statutory Deductions -</option>
							<option value="3">- Adjustment to Overtime -</option>
							<option value="4">- Adjustment to Non-tax Allowance -</option>
							<option value="5">- Other Miscellaneous Adjustments -</option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td align=left>
						<input type="hidden" name="rid" id="rid" value="">
						<select name="is_taxable" id="is_taxable" class="gridInput" style="width: 80%; font-size: 11px;">
