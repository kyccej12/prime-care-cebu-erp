	...
	<script>
		...
		$(document).ready(function() {
			$('#itemlist').dataTable({
				...
				"bProcessing": true,
				"sAjaxSource": "listings.php?mod=employees&dtype=<?php echo $dtype; ?>&sid="+Math.random()+"",
				"aoColumns": [
				  { mData: 'emp_id' },
				  { mData: 'lname' },
				  { mData: 'fname' },
		...
		function repopulate(type) {
			document.frmPopulate.dtype.value = type;
			document.frmPopulate.submit();	
		}
...
<body bgcolor="#ffffff" leftmargin="0" bottommargin="0" rightmargin="0" topmargin="0" >
	<div id="main">
		<table cellspacing=0 cellpadding=0 width=100% align=center style="margin-top: 10px;">
			<tr>
				...
				<td align=right class="bareThin" style="padding-right: 10px;">
					Records On-Display:
					<select name="dtype" id="dtype" class="gridInput" style="width: 250px; font-size: 11px;" onchange="repopulate(this.value);">
						<option value="1">Active Employees</option>
						<option value="2" <?php if($_REQUEST['dtype'] == '2') { echo "selected"; }?>>Archived Files</option>
					</select>
				</td>
			</tr>
		</table>
	...
	<form name="frmPopulate" id="frmPopulate" action="employee.list.php" method="GET">
