<?php
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AM6","SSS CALAMITY LOAN");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AN6","HDMF LOAN");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AO6","HDMF CALAMITY");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AP6","JAG LOAN");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AQ6","COOP LOAN");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AR6","LABORATORY");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AS6","HEALTH INS.");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AT6","OTHER LOANS");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AU6","OTHER DED.");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AV6","TOTAL DED.");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AW6","NET PAY");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AX6","ON HOLD");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AY6","ON CASH");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AZ6","ON ATM");
	...
	$objPHPExcel->getActiveSheet()->getStyle('AX6')->applyFromArray($headerStyle);
	$objPHPExcel->getActiveSheet()->getStyle('AY6')->applyFromArray($headerStyle);
	$objPHPExcel->getActiveSheet()->getStyle('AZ6')->applyFromArray($headerStyle);
	...
	while($data2 = $a->fetch_array()) {
		...
		//$dedTotal = $data2['sss_premium'] + $data2['philhealth_premium'] + $data2['pagibig_premium'] + $data2['wtax'] + $data2['hdmf_loan'] + $data2['hdmf_cloan'] + $data2['sss_loan'] + $data2['sss_cloan'] + $data2['cash_adv'] + $data2['coop_loan'] + $data2['coop_premium'] +  $data2['jag_loan'] + $data2['retirement_plan'] + $data2['health_ins'] + $data2['other_loans'] + $data2['others_total'] + $data2['laboratory'];
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(32,$row,$data2['pagibig_premium']);
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(36,$row,$data2['cash_adv']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(37,$row,$data2['sss_loan']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(38,$row,$data2['sss_cloan']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(39,$row,$data2['hdmf_loan']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(40,$row,$data2['hdmf_cloan']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(41,$row,$data2['jag_loan']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(42,$row,$data2['coop_loan']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(43,$row,$data2['laboratory']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(44,$row,$data2['health_ins']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(45,$row,$data2['other_loans']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(46,$row,$data2['others_total']);


		$dedTotal = $data2['sss_premium'] + $data2['pagibig_premium'] + $data2['philhealth_premium'] + $data2['coop_premium'] + $data2['wtax'] + $data2['cash_adv'] + $data2['sss_loan'] + $data2['sss_cloan'] + $data2['hdmf_loan'] + $data2['hdmf_cloan'] + $data2['jag_loan'] + $data2['coop_loan'] + $data2['laboratory'] + $data2['health_ins'] + $data2['others_total'] + $data2['other_loans'];

		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(47,$row,$dedTotal);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(48,$row,$data2['net_pay']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(49,$row,$data2['on_hold']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(50,$row,$cash);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(51,$row,$atm);
		for($y = 0; $y <= 51; $y++) { $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow($y,$row)->applyFromArray($contentStyle); }
		for($z = 4; $z <= 51; $z++) { if($z!=49) { $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow($z,$row)->getNumberFormat()->setFormatCode('#,##0.00'); }}
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(38,$row,$ssscloanGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(39,$row,$hdmfloanGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(40,$row,$hdmfcloanGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(41,$row,$jagGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(42,$row,$cooploanGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(43,$row,$labGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(44,$row,$hinsGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(45,$row,$otherLoansGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(46,$row,$othersGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(47,$row,$dedTotalGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(48,$row,$netGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(50,$row,$cashGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(51,$row,$atmGT);
	
	for($y = 5; $y <= 51; $y++) { $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow($y,$row)->applyFromArray($totalStyle); }
	for($z = 5; $z <= 51; $z++) { if($z!=49) { $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow($z,$row)->getNumberFormat()->setFormatCode('#,##0.00'); }}
