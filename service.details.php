				...
				"Add Result Attribute": function() {
					...
					if(msg == '') {
						$.post("src/sjerp.php", {
								...
								f_min: $("#f_test_minvalue").val(),
								f_max: $("#f_test_maxvalue").val(),
								p_min: $("#p_test_minvalue").val(),
								p_max: $("#p_test_maxvalue").val(),
		...
		if(!arr[0]) {
			...
			function(data) {
				...
				if(data['attribute'] != '') {
					...
					$("#f_test_minvalue").val(data['f_min_value']);
					$("#f_test_maxvalue").val(data['f_max_value']);
					$("#p_test_minvalue").val(data['p_min_value']);
					$("#p_test_maxvalue").val(data['p_max_value']);
...
<form name="merchandise" id="merchandise">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" >
		...
		<tr>
			...
			<td width="10%" class="spandix-l">Sub-category :</td>
			<td width="40%">
		...
		<tr>
			...
			<td width="10%" class="spandix-l" valign=top style="padding-top: 2px;">Report Category :</td>
			<td width="40%">
				<select name="item_scategory" id="item_scategory" style="width: 70%;" class="nInput">
					<option value="">- Not Applicable -</option>
					<?php
					
						$scQuery = $con->dbquery("select sales_id, sales_category from options_salescategory order by sales_category asc;");
						while(list($scid,$scname) = $scQuery->fetch_array()) {
							echo "<option value='$scid' ";
								if($res['sales_cat'] == $scid) { echo "selected"; }
							echo ">$scname</option>";
						}
						
					?>
				</select><br/>
				<input type="checkbox" name="status" id="status" <?php if($res['active'] == 'N') { echo "checked"; } ?> value="N">&nbsp;<span class="bareGray">Inactive</span>
			</td>
		</tr>
	</table>
...
<div id="testDiv" style="display: none;">
	<form name="frmTestvalue" id="frmTestvalue">
		...
		<table width=100% cellspacing=2 cellpadding=0>
			...
			<tr>
				<td class="bareThin" align=left width=40%>Male</td>
				<td align=left></td>
			</tr>
			<tr>
				<td class="bareThin" align=left width=40% style="padding-left: 20px;">Min. Normal Value :</td>
				<td align=left>
					<input type="text" name="test_minvalue" id="test_minvalue" class="gridInput" style="width: 80%;" >
				</td>
			</tr>
			<tr>
				<td class="bareThin" align=left width=40% style="padding-left: 20px;">Max. Normal Value :</td>
				<td align=left>
					<input type="text" name="test_maxvalue" id="test_maxvalue" class="gridInput" style="width: 80%;" >
				</td>
			</tr>
			<tr>
				<td class="bareThin" align=left width=40%><b>Female</td>
				<td align=left></td>
			</tr>
			<tr>
				<td class="bareThin" align=left width=40% style="padding-left: 20px;">Min. Normal Value :</td>
				<td align=left>
					<input type="text" name="f_test_minvalue" id="f_test_minvalue" class="gridInput" style="width: 80%;" >
				</td>
			</tr>
			<tr>
				<td class="bareThin" align=left width=40% style="padding-left: 20px;">Max. Normal Value :</td>
				<td align=left>
					<input type="text" name="f_test_maxvalue" id="f_test_maxvalue" class="gridInput" style="width: 80%;" >
				</td>
			</tr>
			<tr>
				<td class="bareThin" align=left width=40%>Pedia (0-16yo)</td>
				<td align=left></td>
			</tr>
			<tr>
				<td class="bareThin" align=left width=40% style="padding-left: 20px;">Min. Normal Value :</td>
				<td align=left>
					<input type="text" name="p_test_minvalue" id="p_test_minvalue" class="gridInput" style="width: 80%;" >
				</td>
			</tr>
			<tr>
				<td class="bareThin" align=left width=40% style="padding-left: 20px;">Max. Normal Value :</td>
				<td align=left>
					<input type="text" name="p_test_maxvalue" id="p_test_maxvalue" class="gridInput" style="width: 80%;" >
				</td>
			</tr>
			<tr>
