...
<head>
	...
	<script>
		...
		myInterval1 = setInterval(checkHL7Messages, 30000);
		myInterval2 = setInterval(checkSession, 40000);
...
<body bgcolor="#ffffff" leftmargin="0" bottommargin="0" rightmargin="0" topmargin="0" <?php if($o->cpass == 'Y') { echo "onLoad=\"showChangePass();\""; } ?> style="background: url(images/pcc-bg.jpg); background-size: 100% 100%; background-repeat: no-repeat;">
 <table height="100%" width="100%" border="0" cellspacing="0" cellpadding="0" >
	<tr>
		...
		<td align=right style="height:37px; padding-right: 10px; background-color:#595959; background-image: url(images/4.png);"><img src="images/icons/user.png" align=absmiddle border=0 width=18 height=18 /><span style="font-size: 11px; font-weight: bold; color: #ffffff;">&nbsp;<?php echo $o->getUname($_SESSION['userid']); ?>&nbsp;&nbsp;&nbsp;|</span>&nbsp;<a href="logout.php" style="font-size: 12px; font-weight: bold; color: #ffffff; text-decoration: none;" title="Click to Logout"><img src="images/button-logout.png" align=absmiddle border=0 width=24 height=24 />Logout</a></td>
	</tr>
	<tr height=90%>
		<td colspan=3>
	...
	<tr>
		<td colspan=3>
			<table width="100%" height="100%" cellpadding=0 cellspacing=0 align="center" valign=middle>
				<tr bgcolor="#363535">
					<td align=center style="font-family: arial, helvetica, sans-serif; color: #fefefe; font-size: 11px; height: 15px; font-weight: bold;">&copy; Exclusively Developed for Prime Care Cebu Incorporated by Port80 Business Solutions</td>
				</tr>
			</table>
		</td>
	</tr>
...
<?php 
	...
	include("includes/inventory-reports.php");
	include("includes/labDialogs.php");
	include("includes/hrdivs.php");
	include("includes/peme-reports.php");
...
<div id="consultlist" style="display: none;"></div>
<div id="consultdetails" style="display: none;"></div>
