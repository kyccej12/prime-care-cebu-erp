<?php
	...
	$objPHPExcel->getProperties()->setCreator("Root Admin")
								 ...
								 ->setTitle("$co[company_name] - PROFIT & LOSS STATEMENT")
								 ->setSubject("$co[company_name] - PROFIT & LOSS STATEMENT")
								 ->setDescription("$co[company_name] - PROFIT & LOSS STATEMENT")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("A4","PROFIT & LOSS STATEMENT FOR THE PERIOD $month, $_GET[year] ($pcode)");
	...
	// Rename worksheet
	$objPHPExcel->getActiveSheet()->setTitle("PROFIT & LOSS STATEMENT - CONSOLIDATED");
