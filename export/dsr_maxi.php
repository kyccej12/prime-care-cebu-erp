<?php
	...
	// }
	$query = $mydb->dbquery("SELECT * FROM (SELECT 'so' AS `type`, a.so_no, DATE_FORMAT(a.so_date,'%m/%d/%Y') AS sodate,'' AS or_no, '' AS ordate, a.customer_code, a.customer_name, a.patient_id, a.patient_name, c.description AS xterms, b.code,b.description, b.amount_due, a.amount AS charge_sales, '0' AS cash_sales, '0' AS cc_sales, '0' AS check_sales, '0' AS ad_payment, a.physician, a.referred_by FROM so_header a LEFT JOIN so_details b ON a.trace_no = b.trace_no LEFT JOIN options_terms c ON a.terms = c.terms_id LEFT JOIN services_master d ON b.code = d.code WHERE a.status = 'Finalized' AND a.terms NOT IN ('0','100') AND a.so_date BETWEEN '2023-01-01' AND '2024-08-31' AND a.customer_name LIKE '%MAXI%'

UNION ALL SELECT 'ap' AS `type`, a.so_no, DATE_FORMAT(a.so_date,'%m/%d/%Y') AS sodate,'' AS or_no, '' AS ordate, a.customer_code, a.customer_name, a.patient_id, a.patient_name, c.description AS xterms, b.code,b.description, b.amount_due, '0' AS charge_sales, '0' AS cash_sales, '0' AS cc_sales, '0' AS check_sales, a.amount AS ad_payment, a.physician, a.referred_by FROM so_header a LEFT JOIN so_details b ON a.trace_no = b.trace_no LEFT JOIN options_terms c ON a.terms = c.terms_id WHERE a.status = 'Finalized' AND a.terms IN ('100') AND a.so_date BETWEEN '2023-01-01' AND '2024-08-31' AND a.customer_name LIKE '%MAXI%' 

UNION ALL SELECT 'or' AS `type`, b.so_no, DATE_FORMAT(b.so_date,'%m/%d/%Y') AS so_date, a.or_no AS or_no, DATE_FORMAT(a.doc_date,'%m/%d/%Y') AS ordate, a.customer_code, a.customer_name, b.pid AS patient_id, b.pname AS patient_name, 'Cash' AS terms, b.code, b.description, b.amount_due, 0 AS charge_sales, a.amount_due AS cash_sales, '0' AS cc_sales, '0' AS check_sales, '0' AS ad_payment, '' AS physician, '' AS referred_by FROM or_header a LEFT JOIN or_details b ON a.doc_no = b.doc_no WHERE a.status = 'Finalized' AND a.doc_date BETWEEN '2023-01-01' AND '2024-08-31' AND a.cashtype IN ('1')  AND a.customer_name LIKE '%MAXI%' 

UNION ALL SELECT 'cc' AS `type`, b.so_no, DATE_FORMAT(b.so_date,'%m/%d/%Y') AS so_date, a.doc_no AS or_no, DATE_FORMAT(a.doc_date,'%m/%d/%Y') AS ordate, a.customer_code, a.customer_name, b.pid AS patient_id, b.pname AS patient_name, 'Cash' AS terms, b.code, b.description, b.amount_due, 0 AS charge_sales, cash_tendered AS cash_sales, cc_tendered AS cc_sales, '0' AS check_sales, '0' AS ad_payment, '' AS physician, '' AS referred_by FROM or_header a LEFT JOIN or_details b ON a.trace_no = b.trace_no WHERE a.status = 'Finalized' AND a.doc_date BETWEEN '2023-01-01' AND '2024-08-31' AND a.cashtype IN ('2') AND a.customer_name LIKE '%MAXI%'

UNION ALL SELECT 'ck' AS `type`, b.so_no, DATE_FORMAT(b.so_date,'%m/%d/%Y') AS so_date, a.doc_no AS or_no, DATE_FORMAT(a.doc_date,'%m/%d/%Y') AS ordate, a.customer_code, a.customer_name, b.pid AS patient_id, b.pname AS patient_name, 'Cash' AS terms, b.code, b.description, b.amount_due, 0 AS charge_sales, '0' AS cash_sales, '0' AS cc_sales, a.amount_due AS check_sales, '0' AS ad_payment,'' AS physician, '' AS referred_by FROM or_header a LEFT JOIN or_details b ON a.doc_no = b.doc_no WHERE a.status = 'Finalized' AND a.doc_date BETWEEN '2023-01-01' AND '2024-08-31' AND a.cashtype IN ('3') AND a.customer_name LIKE '%MAXI%') a ORDER BY or_no, so_no;");
