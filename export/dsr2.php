<?php
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("L6","CHARGE SALES");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("M6","CASH SALES");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("N6","CARD SALES");

	for($colheader = 0; $colheader <= 13; $colheader++) { $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow($colheader,6)->applyFromArray($headerStyle); }
	...
	while($data = $query->fetch_array(MYSQLI_BOTH)) {
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(11,$row,$charge);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(12,$row,$cash);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(13,$row,$cc);
		/* NUMBER FORMAT */
		...
		for($contentLoop = 0; $contentLoop <= 13; $contentLoop++) {
	...
	/* TOTAL */
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(11,$row,$chargeGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(12,$row,$cashGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(13,$row,$ccGT);
