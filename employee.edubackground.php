<?php
	...
	$emp_idno = $_GET[eid];
	$_yres = getArray("select * from pccpayroll.emp_edubackground where emp_id = '$emp_idno';");
?>
<html>
<head>
												...
												<table width="100%" border="0">
													...
													<tr>
														...
														<td class=bare>
															...
															<?php
																$spz = mysql_query("select id, specialization from pccpayroll.emp_specialization order by specialization;");
												...
												<table width="100%" border="0">
													...
													<tr>
														...
														<td class=bare>
															...
															<option value="">- Select Specialization -</option>
															<?php
																$spz1 = mysql_query("select id, specialization from pccpayroll.emp_specialization order by specialization;");
