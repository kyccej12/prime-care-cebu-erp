...
<html >
  <head>
    <meta charset="UTF-8">
    <title>Prime Care Cebu Inc. ERP System Version 1.0b</title>
  ...
  <body <?php if(isset($_GET[exception])) { ?> onLoad = "alert('<?php _returnError($_GET[exception]); ?>');" <?php } ?>>
    <div class="login">
		  <h1 style="padding-top: 10px;padding-bottom: 10px;">Prime Care Cebu Incorporated<br><span style="font-size:10px">2nd Level, APM Centrale, A. Soriano Jr. Ave., NRA, Mabolo, Cebu City</span></h1>
      <h1 style="padding-top: 10px;padding-bottom: 10px;">DOCTORS CLINIC<br></h1>
          <form class="form" method="post" action="../authenticate_emr.php">
          <p class="field">
