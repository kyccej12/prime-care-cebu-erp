...
/* MYSQL QUERIES SECTION */
	...
	$h = $con->getArray("SELECT a.trace_no, LPAD(a.soa_no,6,'0') AS soano, a.stub_no, a.customer_code AS cid, a.customer_name AS cname, a.customer_address AS caddr, a.remarks, c.description AS terms, DATE_FORMAT(soa_date,'%M %d, %Y') AS soadate, b.tel_no, b.tin_no, b.cperson, b.bizstyle, a.po_no, if(a.po_date!='00000-00-00',date_format(po_date,'%m/%d/%Y'),'') as pd8, a.referred_by, a.revenue_center, a.vat, a.created_by, a.created_on FROM soa_header a LEFT JOIN contact_info b ON a.customer_code = b.file_id LEFT JOIN options_terms c ON a.terms = c.terms_id WHERE a.soa_no = '$_REQUEST[soa_no]' AND a.branch = '$_SESSION[branchid]';");
	$d = $con->dbquery("SELECT if(so_no != 0,if(source='SO',concat('SO-',LPAD(so_no,6,0)),so_no),'') AS sono, date_format(so_date,'%m/%d/%Y') as sodate, pname, description, amount, source, pid, so_no as xso from soa_details where soa_no = '$_REQUEST[soa_no]' and branch = '$_SESSION[branchid]' order by amount desc, so_date asc, so_no asc, pname asc;");	
...
$mpdf=new mPDF('win-1252','letter','','',10,10,80,35,5,10);
...
<table width="100%" cellpadding=0 cellspaing=0>
	<tr>
		<td align=center><img src="../images/primecare-alpha.png" /></td>
	</tr>
	...
	<tr>
		<td width="100%" align=center><span style="font-weight: bold; font-size: 11pt; color: #000000;">(NO. '.$soano.')</span></td>
	</tr>
	<tr><td height=20></td></tr>
</table>
...
<table class="items" width="100%" style="font-size: 10px; border-collapse: collapse;" cellpadding="2">
	<thead>
		<tr><td colspan=6 style="border: 1px solid black; font-weight: bold;" align=center>PARTICULARS</td></tr>
		<tr>
			<td width="5%" align=center ><b>NO</b></td>
			<td width="25%" align=center ><b>PATIENT</b></td>
			<td width="10%" align=center ><b>REF NO.</b></td>
...
if($h['vat'] == 'Y') {
	$html .= '<tr>
				<td colspan=5 class="mytotals" style="padding-right: 20px;">Grand Total</td>
				<td class="mytotals">'.number_format($gt,2).'</td>
			</tr>
			<tr>
				<td colspan=5 class="mytotals" style="padding-right: 20px;">Vatable Sales</td>
				<td class="mytotals">'.number_format($vatableSales,2).'</td>
			</tr>
			<tr>
				<td colspan=5 class="mytotals" style="padding-right: 20px;">VAT (12%)</td>
				<td class="mytotals">'.number_format($vat,2).'</td>
			</tr>
			<tr>
				<td colspan=5 class="mytotals" style="padding-right: 20px;">VAT Exempt Sales</td>
				<td class="mytotals">'.number_format($vatExemptSales,2).'</td>
			</tr>
			<tr>
				<td colspan=5 class="mytotals" style="padding-right: 20px;">Amount Due</td>
				<td class="mytotals">'.number_format($gt,2).'</td>
			</tr>';
} else {
	$html .= '<tr>
...
$html .= '
		  ...
		  <tr><td colspan=6 align=center style="font-size: 14px; font-weight: bold; text-decoration: underline;">* All payments should be made within '.$h['terms'].'</td></tr>
		  <tr><td colspan=6 height=20>&nbsp;</td></tr>
		  <tr><td colspan=6 class="mytotals" style="text-align: center;">NOTE:  PLEASE ISSUE CHECK PAYABLE TO MEDGRUPPE POLYCLINICS & DIAGNOSTIC CENTER, INC.</td></tr>
		  <tr><td colspan=6 height=20>&nbsp;</td></tr>
		  <tr>
		  <td colspan=3 align=left><b>PREPARED BY:</b><br/><br/>_________________________________<br/><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$billingInCharge.'</b><br/><span style="font-size: 8px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$billingRole.'</span></td>
		  <td colspan=3 align=left style="padding-left: 200px;"><b>NOTED BY:</b><br/><br/>___________________________________<br/><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MS. Janna M. Ragas</b><br/><span style="font-size:8px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Finance Supervisor</span></td>
		  </tr>
		  <tr><td colspan=6 height=20>&nbsp;</td></tr>
		  <tr><td colspan=6 align=center style="padding:20px; font-weight: bold;">ANY BILLING QUESTIONS OR CORRECTIONS MUST BE BROUGHT TO OUR ATTENTION WITHIN SEVEN (7) DAYS FROM RECEIPT OF OTHERWISE TOTAL BILL REFLECTED IS DEEMED CORRECT AND DUE.</td></tr>
	</tbody>
</table>
