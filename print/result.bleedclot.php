...
/* MYSQL QUERIES SECTION */
    ...
    $b = $con->getArray("SELECT bleed_min, bleed_sec, clot_min,clot_sec, verified, verified_by FROM lab_bleed_clot WHERE so_no = '$_REQUEST[so_no]' and branch = '$_SESSION[branchid]' and code = '$_REQUEST[code]' and serialno = '$_REQUEST[serialno]';");	
