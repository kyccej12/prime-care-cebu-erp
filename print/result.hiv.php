...
/* MYSQL QUERIES SECTION */
	...
	$b = $con->getArray("SELECT method,testkit,lotno,date_format(expiry, '%m/%d/%Y') as expiry,result,remarks FROM lab_hivresult WHERE so_no = '$_REQUEST[so_no]' and  branch = '$_SESSION[branchid]' AND `code` = '$_REQUEST[code]' and serialno = '$_REQUEST[serialno]';");
