...
<table width="100%" cellspacing=0 cellpadding=0>
	<tr>
	<td class="billto" width=60% rowspan="7" ><b>PAYEE :</b><br /><span style="font-weight: bold; font-size: 14pt;"><br /><b>'.html_entity_decode($_ihead['supplier_name']).'</b></span><br /><i>'.html_entity_decode($_ihead['supplier_addr']).'<br><b>T-I-N: </b>'.$stin.'<br/><b>Contact #: </b>'.$nos.'</i></td>
	</tr>
	<tr>
...
<table width="100%">
	<tr>	
	 ...
	 <tr>	
		...
		<td width=10%> </td>
		<td width=26% align=center>VP - Finance</td>
	 </tr>
</table>
</div>
<table width=100%>
