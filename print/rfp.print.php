...
/* MYSQL QUERIES SECTION */
	...
	$_ihead = $con->getArray("select  date_format(date_needed,'%m/%d/%Y') as d82,rfp_no, lpad(rfp_no,5,0) as rr, date_format(rfp_date,'%m/%d/%Y') as d8, supplier, supplier_name, supplier_addr, amount, remarks, b.tin_no, b.tel_no from rfp_header a left join contact_info b on a.supplier=b.file_id where rfp_no='$_REQUEST[rfp_no]';");
...
$mpdf=new mPDF('win-1252','FOLIO-N','','',10,10,70,30,10,10);
...
<table width="100%">
	<tr>
		...
		<td width="40%" align=right style="padding-top: 15px;">
			<span style="font-weight: bold; font-size: 11pt; color: #000000;">REQUEST FOR PAYMENT&nbsp;&nbsp;</span><br />
...
<table width="100%" cellspacing=0 cellpadding=0>
	<tr>
	<td class="billto" width=60% rowspan="7" ><b>PAYEE :</b><br /><span style="font-weight: bold; font-size: 10pt;"><br /><b>'.html_entity_decode($_ihead['supplier_name']).'</b></span><br /><i>'.html_entity_decode($_ihead['supplier_addr']).'<br><b>T-I-N: </b>'.$stin.'<br/><b>Contact #: </b>'.$nos.'</i></td>
	</tr>
	<tr>
...
<table width="100%">
	<tr>	
		<td width=26% align=center>PREPARED BY</td>
		<td width=10%> </td>
	 ...
	 <tr>	
		<td width=26% align=center style="border-bottom:1px solid black">Jhessa Camille Maningo</td>
		<td width=10%> </td>
		<td width=26% align=center style="border-bottom:1px solid black">Janna M. Ragas</td>
		<td width=10%> </td>
		<td width=26% align=center style="border-bottom:1px solid black">Tinna P. Aznar, MD</td>
	 </tr>
	 <tr>	
		<td width=26% align=center></td>
		<td width=10%> </td>
		<td width=26% align=center>Accounting Supervisor</td>
		<td width=10%> </td>
		<td width=26% align=center></td>
	 </tr>
</table>
