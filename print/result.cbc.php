...
<table width=100% cellpadding=2 cellspacing=0 style="font-size: 10pt;margin-top:20px;">
    ...
    <tr>
        <td width="100%" colspan=4 style="padding-top: 20px;" align=center>
...
<table width=80% cellpadding=0 cellspacing=5 align=center>
    <tr>
        <td align="left" width=30%><b>PARAMETERS</b></td>
        <td align=center width=30%><b>RESULT</b></td>
        <td align="center" width=10%></td>	
        <td align="left" width=30% style="padding-left: 15px;"><b>NORMAL VALUES</b></td>	
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td align=center>'.$con->checkCBCValues($_ihead['age'],$_ihead['xgender'],"RBC",$b['rbc'],$b['machine']).'</td>
    ...
    <tr>
        ...
        <td align=left colspan=4 style="border-bottom: 1px solid black;">'. $b['remarks'] . '</td>
    </tr>
</table>
