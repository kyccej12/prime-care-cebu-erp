...
<table class="items" width="100%" style="font-size: 10pt; border-collapse: collapse;" cellpadding="1">
<thead>
	<tr>
...
while($row = $_idetails->fetch_array()) {
	...
	$html = $html . '<tr>
	<td align=left class="fontsBig">' .$row['item_code']. '</td>
	<td align=left class="fontsBig">' . htmlentities($row['description']) . '</td>
	<td align="center" class="fontsBig">' . $con->identUnit($row['unit']) . '</td>
	<td align="center" class="fontsBig">' . $row['lot_no'] . '</td>
	<td align="center" class="fontsBig">' . $row['expiry'] . '</td>
	<td align="right" class="fontsBig">' . number_format($row['qty'],2) . '</td>
	<td align="right" class="fontsBig">' .number_format($row['cost'],2) . '</td>
	<td align="right" class="fontsBig">' .number_format($row['amount'],2) . '</td>
