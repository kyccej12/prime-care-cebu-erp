<?php
	...
	for($i = 0; $i <= 11; $i++) {
		...
		list($amt2) = $con->getArray("select sum(debit-credit) from acctg_gl a inner join acctg_accounts b ON a.acct = b.acct_code where doc_date between '$ly_dtf' and '$ly_dt2' and b.acct_grp in ('11','12','13') AND a.branch = '1';");
