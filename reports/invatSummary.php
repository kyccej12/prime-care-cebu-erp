...
<table width="100%">
	<tr>
		...
		<td width="40%" align=right>
			<span style="font-weight: bold; font-size: 9pt; color: #000000;">Summary of Purchases<br/><span style="font-size: 6pt; font-style: italic;">Date Covered ' . $_GET['dtf'] . ' - ' . $_GET['dt2'] .'</span>
		</td>
	</tr>
</table>
</htmlpageheader>
...
while($row = $query->fetch_array(MYSQLI_BOTH)) {
		...
		$html = $html . '<tr>
			...
			<td align=center>' . $row['ewt_code'] . '</td>
