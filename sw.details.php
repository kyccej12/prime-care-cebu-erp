		...
		<table border="0" cellpadding="0" cellspacing="1" width=100% class="td_content">
			<tr>
				<td width=50% valign=top>
					<table width=100%>
						<tr>
							<td class="bareBold" align=left width=35% style="padding-left: 10px;">Withdrawn or Requested By :</td>
							<td align="left">
						...
						<tr>
							<td class="bareBold" align=left style="padding-left: 10px;">Purpose of Withdrawal&nbsp;:</td>
							<td align=left>
						...
						<tr>
							<td class="bareBold" align=left style="padding-left: 10px;">Cost Center&nbsp;:</td>
							<td align=left>
						...
						<tr>
							<td class="bareBold" align=left style="padding-left: 25px;">PPP Site&nbsp;:</td>
							<td align=left>
						...
						<tr>
							<td class="bareBold" align=left style="padding-left: 25px;">Clinic&nbsp;:</td>
							<td align=left>
								<select class="gridInput" style="width:70%;" name="clinic_id" id="clinic_id" >
									<option value=''>- Not Applicable -</option>
									<?php
										$clinicQuery = $con->dbquery("select id, clinic from options_clinics order by clinic;");
										while($clinicRow = $clinicQuery->fetch_array()) {
											echo "<option value='$clinicRow[0]' ";
											if($res['clinic_id'] == $clinicRow[0]) { echo "selected"; }
											echo ">$clinicRow[1]</option>";
										}
									?>
								</select>
							</td>				
