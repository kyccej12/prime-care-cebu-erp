...
<script>
	...
	function exportExcel() {
		window.open("export/servicelist.php?sid="+Math.random()+"","Export to Excel Service List","location=1,status=1,scrollbars=1,width=640,height=720");
	}
			...
			<table width="100%" cellspacing="0" cellpadding="0" style="padding-left: 5px; margin-bottom: 2px;">
				<tr>
					<td>
						...
						<button class="ui-button ui-widget ui-corner-all" onClick="serviceList();">
							<a href="#" id="edit" class="topClickers" onClick="exportExcel();"><img src="images/icons/excel.png" width=18 height=12 align=absmiddle />&nbsp;Export to Excel Services List</a>&nbsp;&nbsp;
						</button>
					</td>
				</tr>
			</table>
			<table class="cell-border" id="itemlist" style="font-size:10px;">
				<thead>
					<tr>
						<th>RECORD ID</th>
						<th width=5%>CODE</th>
