<?php
	...
	$r = $con->dbquery("SELECT CONCAT('(',LPAD(file_id,6,0),') ',tradename) AS label, LPAD(file_id,6,0) AS cid, tradename, a.address, a.brgy, a.city, a.province, a.terms, a.price_level, a.tin_no, a.type, delivery_type FROM contact_info a WHERE LOCATE('$term',tradename) > 0 and a.record_status != 'Deleted';");
	...
	if($r) {
		while($row = $r->fetch_array()) {
			...
			$my_arr_row['delivery_type'] = $row['delivery_type'];
