<?php
	...
	$con->dbquery("update acctg_gl set tmp_cleared='N' where tmp_cleared='Y' and acct = '$_REQUEST[acct_code]' and branch = '1';");
	
	$date = $con->formatDate($_POST['xdate']);
	
	$cleared_d8 = $con->getArray("select distinct cleared_on from acctg_gl where cleared_on < '$date' and acct = '$_POST[acct_code]' and branch = '1' order by cleared_on desc limit 1;");
