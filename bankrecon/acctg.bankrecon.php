			...
			<td align=left style="padding-left: 20px;">
				<select name="acct_code" style="width: 300px;">
					<?php
						...
						$q = $con->dbquery("select acct_code,concat('[',acct_code,']', description) as bank from acctg_accounts where acct_grp = '1' and acct_code not in ('10102','10103') order by acct_code;");
						while(list($acct,$bank) = $q->fetch_array()) {
