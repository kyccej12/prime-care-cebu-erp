<?php 
    ...
    $b = $o->getArray("select *, DATE_FORMAT(prev_ecg_date,'%m/%d/%Y') AS prev_ecg_date from lab_ecgresult where so_no = '$a[myso]' and branch = '$_SESSION[branchid]' and `code` = '$a[code]' and serialno = '$a[serialno]';");

    list($verified) = $o->getArray("select verified from lab_ecgresult where so_no = '$a[myso]' and branch = '$_SESSION[branchid]' and code = '$a[code]' and serialno = '$a[serialno]';");
?>
<html>
<head>
    ...
    <table width=100% cellpadding=0 cellspacing=0 valign=top>
        <tr>
            ...
            <td width=45% valign=top style="padding-left:5px;">  
                <iframe  style="border-style: none;" src="<?php echo $file ?>" width="100%" height="500px"></iframe>
            </td>
        </tr>
    </table>
