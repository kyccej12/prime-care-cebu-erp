...
<script>
	...
	$(document).ready(function() {
		var myTable = $('#itemlist').DataTable({
			...
			"bProcessing": true,
			"responsive": true,
			"sAjaxSource": "data/phleblist.php?displayPending=<?php echo $_REQUEST['displayPending'] . "&sid=" . $_REQUEST['sid']; ?>",
			"scroller": true,
			"order": [[13,'desc'],[1,"asc"]],
	...
	function refreshList() {
		...
		var xurl = "data/phleblist.php?type="+type+"&sid="+Math.random()+"";
...
<form name="frmDisplayType" id="frmDisplayType" action="phleb.list.php" method="GET">
