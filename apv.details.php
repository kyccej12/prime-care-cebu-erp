...
<div id="applyDivs" style="padding: 10px; display: none;">
	<form name="applydocs" id="applydocs">
		<table align=center border=0 width=100% cellpadding=0 cellspacing=3>
			<tr><td height=2></td></tr>
			<tr><td class=spandix-l align=left style="padding-right: 10px;">Reference # :</td>
				<td align=left>
					<input type=text id="app_docno" name="app_docno" class="gridInput" style="width:90%;">
				</td>
			</tr>
			<tr><td height=2></td></tr>
			<tr><td class=spandix-l align=left style="padding-right: 10px;">Date :</td>
				<td align=left>
					<input type=text id="app_docdate" name="app_docdate" class="gridInput" style="width:90%;" >
				</td>
			</tr>
			<tr><td class=spandix-l align=left style="padding-right: 10px;">Amount :</td>
				<td align=left>
					<input type=text id="app_amount" name="app_amount" class="gridInput" style="width:90%;">
				</td>
			</tr>
			<tr><td height=2></td></tr>
			<tr><td class=spandix-l align=left style="padding-right: 10px;">Acct Code :</td>
				<td align=left>
					<input type=text id="app_acctcode" name="app_acctcode" class="inputSearch2" style="width:90%; padding-left: 22px;">
				</td>
			</tr>
			<tr><td height=2></td></tr>
			<tr><td class=spandix-l align=left style="padding-right: 10px;">Acct Description :</td>
				<td align=left>
					<input type=text id="app_acctdesc" name="app_acctdesc" class="gridInput" style="width:90%; padding-left: 22px;">
				</td>
			</tr>
			<tr><td height=2></td></tr>
			<tr><td class=spandix-l align=left style="padding-right: 10px;">Vatable :</td>
				<td align=left>
					<select name="app_vatable" id="app_vatable" class="gridInput" style="width:50%;;">
			...
			<tr><td height=2></td></tr>
			<tr><td class=spandix-l align=left style="padding-right: 10px;">Tax Code :</td>
				<td align=left>
					<select name="app_atc" id="app_atc" class="gridInput" style="width:50%;;">
						<option value="">- NA -</option>
						<?php
