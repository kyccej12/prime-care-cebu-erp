		...
		switch($status) {
			...
			case "Active": default:
				...
				$headerControls = '
						...
						<button type = "button" class="ui-button ui-widget ui-corner-all" onClick="saveSOHeader2();">
				...
				<td valign=top>
					<table border="0" cellpadding="0" cellspacing="1" width=100%>
						...
						<tr>
							...
							<td align=left>
								<input class="gridInput" style="width:85%;" type=text name="hmo_card_no" id="hmo_card_no" value="<?php echo $res['hmo_card_no']; ?>" onchange='javascript: saveSOHeader2();'>
							</td>				
						</tr>
						<tr>
							<td align="left" width="50%" class="bareBold" style="padding-left: 35px;">HMO Card Expiry Date&nbsp;:</td>
							<td align=left>
								<input class="gridInput" style="width:85%;" type=text name="hmo_expiry_date" id="hmo_expiry_date" value="<?php echo $res['exd8']; ?>">
							</td>				
						</tr>
						<tr>
		...
		<table width=100% class="td_content">
			<tr>
				<td width=50%>
					...
					<textarea rows=2 type="text" id="remarks" style="width:83%;" onchange='javascript: saveSOHeader2();'><?php echo $res['remarks']; ?></textarea>
				</td>
