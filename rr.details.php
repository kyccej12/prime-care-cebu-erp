...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
	...
	<script>
		...
		$(document).ready(function($){
			...
			$("#po_date").datepicker(); $("#rr_date").datepicker(); $("#invoice_date").datepicker(); $("#itemExpiry").datepicker({ changeMonth: true, cahngeYear: true });
			...
			$('#details').dataTable({
				...
				"aoColumnDefs": [
					{ className: "dt-body-center", "targets": [1,3,4,5,7,8]},
...
<div style="padding: 10px;">
	<form name="xform" id="xform">
		...
		<table id="details" class="cell-border">
			<thead>
				<tr>
					<th></th>
					<th></th>
...
<div id="itemEntry" style="display: none;">
	<form name="frmItemEntry" id="frmItemEntry">
		...
		<table width="100%" cellspacing=2 cellpadding=0 >
			...
			<tr>
				<td class="bareThin" align=left width=40%>Lot # :</td>
				<td align=left>
					<input type="text" name="itemLot" id="itemLot" class="gridInput" style="width: 80%;">
				</td>
			</tr>
			<tr>
				<td class="bareThin" align=left width=40%>Expiry Date</td>
				<td align=left>
